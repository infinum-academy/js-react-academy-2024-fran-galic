...
export const ReviewForm = ({onAdd}: IReviewFormProps) => {
   ...
   return (
      <Stack spacing='4' maxW='container.sm'>
         ...
         <Input placeholder='Add rating' borderRadius='xl' bg='white' fontSize='xs' color="black" width="150px" size='md' id="grade"/>
         <Button bg="white" borderRadius='3xl' fontSize='xs' width="70px" size='sm' onClick={addShowReview}>Post</Button>
      </ Stack>
   );
}